...
export const Footer = () => {
  ...
  return (
    ...
    <Typography sx={labelStyles}>
        <a 
            href="mailto:Wardrobewave@gmail.com" 
            style={{ textDecoration: 'none', color: 'inherit' }}
        >
            Wardrobewave@gmail.com
        </a>
    </Typography>
    <Typography variant='h6'>Address:</Typography>
    <Typography sx={labelStyles}>11th Aagam Avenue, Sabarmati, Ahmedabad-380005</Typography>
</Stack>
                {/* <Stack rowGap={'1rem'} padding={'1rem'}>
            ...
            <Stack alignSelf={"center"}>
                <Typography color={'GrayText'}>&copy; Wardrobwave {new Date().getFullYear()}. All right reserved</Typography>
            </Stack>
