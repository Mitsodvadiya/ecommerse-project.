            ...
            <Stack rowGap={3}>
                ...
                <Stack flexDirection={'row'} >
                    ...
                    <FormControl fullWidth>
                        ...
                        <Select defaultValue={selectedProduct.gender._id} {...register("gender",{required:"gender is required"})} labelId="gender-selection" label="gender">
                            
                            {
                                genders.map((gender)=>(
                                    <MenuItem value={gender._id}>{gender.name}</MenuItem>
                                ))
                            }
