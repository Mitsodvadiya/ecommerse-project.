                ...
                products.map((product)=>(
                    <Stack>
                        <Stack sx={{opacity:product.isDeleted?.7:1}}>
                            <ProductCard key={product._id} id={product._id} title={product.title} thumbnail={product.thumbnail} gender={product.gender.name} price={product.price} isAdminCard={true}/>
                        </Stack>
