    ...
    <Stack width={'100vw'} height={'100vh'} flexDirection={'row'} sx={{overflowY:"hidden"}}>
        ...
        <Stack flex={1} justifyContent={'center'} alignItems={'center'}>
              ...
              <Stack flexDirection={'row'} justifyContent={'center'} alignItems={'center'}>
                ...
                <Stack rowGap={'.4rem'}>
                  <Typography variant='h2' sx={{wordBreak:"break-word"}} fontWeight={600}>WARDROBE WAVE</Typography>
                  <Typography alignSelf={'flex-end'} color={'GrayText'} variant='body2'>- Redefine Your Wardrobe</Typography>
                </Stack>
